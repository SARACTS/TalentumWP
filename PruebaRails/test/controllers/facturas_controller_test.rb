...
class FacturasControllerTest < ActionController::TestCase
  ...
  test "should create factura" do
    assert_difference('Factura.count') do
      post :create, factura: { codigoFactura: @factura.codigoFactura, nombreCliente: @factura.nombreCliente, valor: @factura.valor }
    end
  ...
  test "should update factura" do
    patch :update, id: @factura, factura: { codigoFactura: @factura.codigoFactura, nombreCliente: @factura.nombreCliente, valor: @factura.valor }
    assert_redirected_to factura_path(assigns(:factura))
  end
